...
/**
 * @extends ServiceEntityRepository<Commente>
 *
...
class CommenteRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(Commente $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Commente $entity, bool $flush = true): void
    {
